...
import TOMLEditor from '../../../components/ConfigEditor/TOMLEditor'
import { SERVICE_TYPES } from '../../../config/constants'

export default function GatewayServiceConfig() {
  const {
    loading,
    config,
    setConfig,
    ...
    validateConfig,
    reloadConfig,
  } = useConfig(SERVICE_TYPES.GATEWAY)
  ...
  return (
    <div>
      ...
      >
        <TOMLEditor value={config} onChange={(value) => setConfig(value || '')} />
        {hasChanges && (
